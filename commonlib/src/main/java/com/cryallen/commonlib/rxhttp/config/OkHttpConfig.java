package com.cryallen.commonlib.rxhttp.config;

import android.content.Context;
import android.text.TextUtils;

import com.cryallen.commonlib.rxhttp.cookie.CookieJarImpl;
import com.cryallen.commonlib.rxhttp.cookie.store.CookieStore;
import com.cryallen.commonlib.rxhttp.interceptor.HeaderInterceptor;
import com.cryallen.commonlib.rxhttp.interceptor.NetCacheInterceptor;
import com.cryallen.commonlib.rxhttp.interceptor.NoNetCacheInterceptor;
import com.cryallen.commonlib.rxhttp.interceptor.RxHttpLoggerInterceptor;
import com.cryallen.commonlib.rxhttp.interfaces.BuildHeadersListener;
import com.cryallen.commonlib.rxhttp.retrofit.SSLUtils;
...
public class OkHttpConfig {
    ...
    public static class Builder {
        ...
        // 无网络时，设置超时为4周
        private int noNetCacheTime = 60 * 60 * 24 * 28;
        ...
        private void setDebugConfig() {
            if (isDebug) {
                HttpLoggingInterceptor logInterceptor = new HttpLoggingInterceptor(new RxHttpLoggerInterceptor());
