package com.cryallen.commonlib.mvvm.fragment;
...
import com.cryallen.commonlib.mvvm.activity.IBaseMvvmView;
...
public abstract class LazyMvvmCompatFragment<V extends ViewDataBinding,VM extends IMvvmBaseViewModel> extends BaseCompatFragment implements IBaseMvvmView {
	...
	private void dispatchChildVisibleState(boolean visible) {
		...
		if (null != fragments) {
			for (Fragment fragment : fragments) {
				if (fragment instanceof LazyMvvmCompatFragment && !fragment.isHidden()
						&& fragment.getUserVisibleHint()) {
					((LazyMvvmCompatFragment)fragment).dispatchUserVisibleHint(visible);
				}
			}
		}
	}
	...
	private boolean isParentInvisible() {
		...
		if (parentFragment instanceof LazyMvvmCompatFragment)
		{
			LazyMvvmCompatFragment fragment = (LazyMvvmCompatFragment) parentFragment;
			return !fragment.isCurrentSupportVisible();
		}
		return false;
	}

	private boolean isCurrentSupportVisible()
	{
