...
import com.cryallen.commonlib.utils.ResourcesUtils;
...
public class DownloadProgressButton extends AppCompatTextView {
	...
	private void initAttrs(Context context, AttributeSet attrs) {
		...
		try {
			mBackgroundColor = typedArray.getColor(R.styleable.DownloadProgressButton_progress_btn_background_color, ResourcesUtils.getColor(R.color.common_download_progress_btn_background_color));
			mBackgroundSecondColor = typedArray.getColor(R.styleable.DownloadProgressButton_progress_btn_background_second_color, ResourcesUtils.getColor(R.color.common_download_progress_btn_background_second_color));
			mButtonRadius = typedArray.getDimension(R.styleable.DownloadProgressButton_progress_btn_radius, 0);
			mTextColor = typedArray.getColor(R.styleable.DownloadProgressButton_progress_btn_text_color, mBackgroundColor);
			mTextCoverColor = typedArray.getColor(R.styleable.DownloadProgressButton_progress_btn_text_cover_color, Color.WHITE);
			mBorderWidth = typedArray.getDimension(R.styleable.DownloadProgressButton_progress_btn_border_width, dp2px(2));
			mBallStyle = typedArray.getInt(R.styleable.DownloadProgressButton_progress_btn_ball_style, STYLE_BALL_JUMP);
		} finally {
			typedArray.recycle();
		}
	}
	...
	public Parcelable onSaveInstanceState() {
		...
		String currentText = "";
		if(mCurrentText != null){
			currentText = mCurrentText.toString();
		}
		return new SavedState(superState, (int) mProgress, mState, currentText);
	}
