...
public final class HttpsUtils {
    ...
    public static TrustManager[] prepareTrustManager(InputStream... certificates) throws Exception {
    ...
    public static KeyManager[] prepareKeyManager(InputStream bksFile, String password) throws Exception{
