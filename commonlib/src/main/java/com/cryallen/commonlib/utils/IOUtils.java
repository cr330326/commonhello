...
import com.cryallen.commonlib.io.Charsets;
import com.cryallen.commonlib.io.StringCodingUtils;
import com.cryallen.commonlib.io.stream.ByteArrayOutputStream;
import com.cryallen.commonlib.io.stream.StringBuilderWriter;
...
public class IOUtils {
     ...
     * before using {@link cn.finalteam.toolsfinal.io.IOUtils#toByteArray(InputStream, int)} to read into the byte array.
     ...
     * @see cn.finalteam.toolsfinal.io.IOUtils#toByteArray(InputStream, int)
     * @since 2.1
     */
