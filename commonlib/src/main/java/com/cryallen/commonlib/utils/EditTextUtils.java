...
public class EditTextUtils {
     ...
     */
    public static void divideEditTextWithGroup(@NonNull final EditText editText, @IntRange(from = 1) final int groupCount, final char separator) {
    ...
    public static void makeEditTextWithAmountInput(final EditText editText, float minMoney, final float allMoney) {
        editText.addTextChangedListener(new TextWatcher() {
            @Override
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
            }
